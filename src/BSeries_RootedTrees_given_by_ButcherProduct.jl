...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
"""
    exact_value_butcher(index::Int,data::Data_given_by_ButcherProduct) -> Rational{Integer}
...
```       
"""
function exact_value_butcher(index::Int,data::Data_given_by_ButcherProduct)
...
"""
    exact_series_butcher(order::Int,data::Data_given_by_ButcherProduct,V::DataType=Rational{Integer}) -> OrderedDict{Int,V}
...
"""
function exact_series_butcher(order::Int,data::Data_given_by_ButcherProduct,V::DataType=Rational{Integer})
