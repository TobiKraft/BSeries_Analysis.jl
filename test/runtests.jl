...
@testset "BSeries_CircProduct.jl" begin
    ...
    @test data.circProduct_data==Data_given_by_CircProduct([(1,0),(1,1),(2,1),(1,2),(3,1),(4,1),(1,3),(1,4)],4,[1,2,3,5,9])
end
